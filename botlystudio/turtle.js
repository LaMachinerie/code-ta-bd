...
Turtle.resizeCanvas = function(){
  if(document.getElementById('visualization').offsetWidth != 0){
    document.getElementById('display').style.width = document.getElementById('visualization').offsetWidth + 'px';
    document.getElementById('scratch').style.width = document.getElementById('visualization').offsetWidth + 'px';
  }
  document.getElementById('display').style.height = document.getElementById('display').style.width + 'px'; 
  document.getElementById('scratch').style.width = document.getElementById('display').style.width + 'px';
}
