 ...
 *
 * @fileoverview JavaScript to configure front end design for BotlyStudio app.
 */
'use strict';
...
BotlyStudio.designJsInit = function() {
  BotlyStudio.materializeJsInit();
  BotlyStudio.resizeToggleToolboxBotton();
  BotlyStudio.sketchNameSizeEffect();
  BotlyStudio.sketchNameSet();
};
 ...
 */
BotlyStudio.materializeJsInit = function() {
  // Navigation bar
 ...
 */
BotlyStudio.displayToolbox = function(show) {
 ...
 */
BotlyStudio.materialAlert = function(title, body, confirm, callback) {
 ...
 */
BotlyStudio.openAdditionalBlocksModal = function(htmlContent) {
 ...
 */
BotlyStudio.createExtraBlocksCatHtml = function(title, description, clickBind) {
 ...
 */
BotlyStudio.MaterialToast = function(message) {
 ...
 */
BotlyStudio.arduinoIdeOutput = function(bodyEl) {
  ...
  BotlyStudio.highlightIdeOutputHeader();
};
 ...
 * @param {!element} bodyEl HTML to include into IDE output content area.
 */
BotlyStudio.resetIdeOutputContent = function(bodyEl) {
  var ideOuputContent = document.getElementById('content_ide_output');
  ideOuputContent.innerHTML = '<span class="arduino_dialog_out">' +
      BotlyStudio.getLocalStr('arduinoOpWaiting') + '</span>';
};
 ...
 */
BotlyStudio.sketchNameSizeEffect = function() {
 ...
 */
BotlyStudio.sketchNameSet = function(newName) {
...
BotlyStudio.highlightIdeOutputHeader = function() {
 ...
 */
BotlyStudio.contentHeightToggle = function() {
  ...
  var xml = document.getElementById('visualization');
 ...
 * @private
 */
BotlyStudio.getBBox_ = function(element) {
